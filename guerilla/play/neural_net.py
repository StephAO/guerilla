...
class NeuralNet:
    ...
    def __init__(self, load_file=None, load_hp_file=None, nn_input_type='bitmap',
        ...
        if load_hp_file is not None:
            self.set_hyper_params_from_file(load_hp_file)
        else:
        ...
        elif self.hp['NN_INPUT_TYPE'] == 'bitmap' and self.use_conv:
            self.W_grid = None
            self.W_rank = None
            self.W_file = None
            self.W_diag = None
